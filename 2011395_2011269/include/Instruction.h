...
class Instruction {
   public:
    ...
    MachineOperand* getImmInt(int i){ return (new MachineOperand(MachineOperand::IMM,i));}
    MachineOperand* getVreg(int i){ return (new MachineOperand(MachineOperand::VREG,i));}
    MachineOperand* getLabel(std::string s){return (new MachineOperand(s));}
    MachineOperand* getReg(int i){return (new MachineOperand(MachineOperand::REG,i));}
...
class GepInstruction : public Instruction {
   ...
   public:
    ...
    void setInitOperand(Operand* initOperand) { this->initOperand = initOperand; };
    //下面这些是自己加的
    MachineOperand* globald;
    MachineOperand* globals1;
    MachineOperand* globals2;
    MachineOperand* globali1;
    MachineOperand* globali2;
    MachineOperand* globalb1;
    void setGlobald(MachineOperand* mo){this->globald=mo;}
    void setGlobals1(MachineOperand* mo){this->globals1=mo;}
    void setGlobals2(MachineOperand* mo){this->globals2=mo;}
    void setGlobali1(MachineOperand* mo){this->globali1=mo;}
    void setGlobali2(MachineOperand* mo){this->globali2=mo;}
    void setGlobalb1(MachineOperand* mo){this->globalb1=mo;}
    MachineOperand* getGlobald(){return globald;}
    MachineOperand* getGlobals1(){return globals1;}
    MachineOperand* getGlobals2(){return globals2;}
    MachineOperand* getGlobali1(){return globali1;}
    MachineOperand* getGlobali2(){return globali2;}
    MachineOperand* getGlobalb1(){return globalb1;}
    Operand* getOperands(int i ){return operands[i];}
    int getHalf(int i){return i/2;}
    int GepSize=0;
