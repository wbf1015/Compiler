...
static const yytype_int16 yyrline[] =
{
     ...
     504,   515,   515,   556,   560,   566,   570,   576,   579,   584,
     587,   592,   622,   648,   648,   683,   709,   731,   731,   766,
     771,   766,   798,   802,   805,   808,   817
};
#endif
...
static const char *const yytname[] =
{
  ...
  "INT", "VOID", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACKET",
  "RBRACKET", "COMMA", "SEMICOLON", "ADD", "SUB", "MUL", "DIV", "MOD",
  "OR", "AND", "LESS", "LESSEQUAL", "GREAT", "GREATEQUAL", "ASSIGN",
...
#line 622 "src/parser.y"
        ...
        if(stk.empty()){
            ...
            idx += curArrayType->getSize() / TypeSystem::intType->getSize();
...
#line 648 "src/parser.y"
        ...
        SymbolEntry* se;
        if(!stk.empty())
            curArrayType = (ArrayType*)(((ArrayType*)(stk.top()->getSymbolEntry()->getType()))->getElementType());
        se = new ConstantSymbolEntry(curArrayType);
